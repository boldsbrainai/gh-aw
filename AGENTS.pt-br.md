...
- **[agentic-chat](.github/aw/agentic-chat.md)** - Assistente de IA para criar descrições de tarefas

### MCP e Ferramentas
- **[skillz-integration](skills/skillz-integration/SKILL.md)** - Integração do servidor Skillz MCP com o Docker

**Lembre-se**: Seja PREGUIÇOSO - carregue uma skill apenas quando realmente precisar de seu conhecimento especializado. Não faça referência a skills preventivamente.
