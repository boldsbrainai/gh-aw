...
- Converter arquivos de saída compatíveis com TypeScript para CommonJS e remover a compilação do TypeScript
- Atualizar o Claude Code CLI para a versão 2.0.10
