...
- @zkoppert: [#27741](https://github.com/github/gh-aw/issues/27741) _(tópico direto)_

</details>
## Compartilhe seus comentários

Agradecemos seus comentários sobre o GitHub Agentic Workflows! 

- [Discussões de feedback da comunidade](https://github.com/orgs/community/discussions/186451)
- [GitHub Next Discord](https://gh.io/next-discord)

## Peli's Agent Factory

Consulte a [Fábrica de Agentes da Peli](https://github.github.com/gh-aw/blog/2026-01-12-welcome-to-pelis-agent-factory/) para um tour guiado pelas diversas utilizações dos fluxos de trabalho agenticos.

## Projetos relacionados

O GitHub Agentic Workflows é apoiado por projetos complementares que oferecem recursos adicionais de segurança e integração:

- **[Agent Workflow Firewall (AWF)](https://github.com/github/gh-aw-firewall)** - Controle de saída de rede para agentes de IA, fornecendo controles de acesso baseados em domínio e registro de atividades para a execução segura de fluxos de trabalho
- **[MCP Gateway](https://github.com/github/gh-aw-mcpg)** - Encaminha chamadas do servidor Model Context Protocol (MCP) por meio de um gateway HTTP unificado para gerenciamento centralizado de acesso
- **[gh-aw-actions](https://github.com/github/gh-aw-actions)** - Biblioteca compartilhada de GitHub Actions personalizadas usadas por fluxos de trabalho compilados, oferecendo funcionalidades como gerenciamento de arquivos do servidor MCP
