...
- **Leia a documentação**: Acesse `https://github.github.com/gh-aw/`

## Referência

- **Script de instalação**: `https://raw.githubusercontent.com/github/gh-aw/main/install-gh-aw.sh`
- **Documentação**: `https://github.github.com/gh-aw/`
- **Repositório**: `https://github.com/github/gh-aw`
- **Guia detalhado de configuração**: Consulte `install.md` no repositório gh-aw
